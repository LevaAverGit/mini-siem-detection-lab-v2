...
- Unified event ingestion pipeline (5 sources)
- Normalized event model
- Rule-based detection engine (14 rules, YAML-configurable)
...
| Testing discipline | 200 tests, ASGITransport, tmp_path isolation |
| CI/CD | GitHub Actions CI |
| Observability | Structured JSON logging, normalized event messages |
| Security engineering | 14 detection rules, triage lifecycle |
