...
| Testing discipline | 200 tests, ASGITransport, tmp_path DB isolation, 0 warnings | `tests/`, `docs/QUALITY_ASSURANCE.md` |
...
| Security engineering | 14 detection rules, severity scoring, evidence, recommendations | `app/services/detection_engine.py` |
